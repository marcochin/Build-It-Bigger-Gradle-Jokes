 ...
 * on 2015-09-28 at 21:46:57 UTC 
 * Modify at your own risk.
 */

package com.example.marco.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://gradlejokes.appspot.com/_ah/api/";
  ...
  public class GetJoke extends MyApiRequest<com.example.marco.myapplication.backend.myApi.model.Joke> {
     ...
     */
    protected GetJoke() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.marco.myapplication.backend.myApi.model.Joke.class);
    }
  ...
  public class SayHi extends MyApiRequest<com.example.marco.myapplication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.marco.myapplication.backend.myApi.model.MyBean.class);
